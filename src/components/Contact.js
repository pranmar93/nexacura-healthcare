...
function Contact() {
  return (
    <section id="contact" className="bg-gray-100 py-0 md:py-0 lg:py-0 mt-8 md:mt-12 lg:mt-16 w-full max-w-full overflow-x-hidden">
      <div className="w-full max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-md mx-auto text-center">
          ...
          <p className="text-gray-600 text-sm sm:text-base mb-4">
            Email:{' '}
            <a
              href="mailto:shivendra.singh@nexacurahealthcare.com"
              className="text-blue-500 font-medium hover:underline"
            >
              shivendra.singh@nexacurahealthcare.com
            </a>
          </p>
